...
if config('STAGE') == 'dev':
    ...
    CSRF_TRUSTED_ORIGINS = ['https://gastroplatz.ch', 'https://127.0.0.1:8000/', 'https://gebomp.herokuapp.com', 'gastroplatz.ch', 'www.gastroplatz.ch','https://www.gastroplatz.ch','gebomp.herokuapp.com']
