...
ALLOWED_HOSTS = ['https://gastroplatz.ch', 'https://127.0.0.1:8000/', 'https://marktplatz.herokuapp.com']
...
if config('STAGE') == 'dev':
    ...
    CSRF_TRUSTED_ORIGINS = ['https://gastroplatz.ch', 'https://marktplatz.herokuapp.com', 'https://127.0.0.1:8000/']
